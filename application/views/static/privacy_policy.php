...
<div class="container">
	...
	<div class="row">
		<div class="span8">
		<h6 class="text-info">This Privacy Policy governs the manner in which Beyond Horizons EduConnect Pvt Ltd collects, uses, maintains and discloses information collected from users (each, a "User") of the www.meetuniv.com website ("Site"). This privacy policy applies to the Site and all products and services offered by Beyond Horizons EduConnect Pvt Ltd.</h6>

<h5 class="text-success">Personal identification information</h5>
...
<h5 class="text-success">Non-personal identification information</h5>
...
<h5 class="text-success">Web browser cookies</h5>
...
<h5 class="text-success">How we use collected information</h5>

<h6>Beyond Horizons EduConnect Pvt Ltd may collect and use Users personal information for the following purposes:</h6>
<ul>
	...
	<li>To run a promotion, contest, survey or other Site feature<br/>
...
<h5 class="text-success">How we protect your information</h5>
...
<h5 class="text-success">Sharing your personal information</h5>
...
<h5 class="text-success">Third party websites</h5>
...
<h5 class="text-success">Advertising</h5>
...
<h5 class="text-success">Google Adsense</h5>

Some of the ads may be served by Google. Google's use of the DART cookie enables it to serve ads to Users based on their visit to our Site and other sites on the Internet. DART uses "non personally identifiable information" and does NOT track personal information about you, such as your name, email address, physical address, etc. You may opt out of the use of the DART cookie by visiting the Google ad and content network privacy policy at http://www.google.com/privacy_ads.html<br/><br/>

<h5 class="text-success">Changes to this privacy policy</h5>

Beyond Horizons EduConnect Pvt Ltd has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br/><br/>

<h5 class="text-success">Your acceptance of these terms</h5>
...
<h5 class="text-success">Contacting us</h5>

If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:<br/>
<address>
<strong>Beyond Horizons EduConnect Pvt Ltd</strong><br>
<a href="<?php echo base_url();?>" style="text-decoration:none;">www.meetuniv.com</a><br>
Beyond Horizons Educonnect Pvt Ltd E-11 Greater Kailash -1 , New Delhi<br>
+91-11-41078540<br>
content@meetuniv.com</address>

This document was last updated on September 02, 2013<br/><br/>

Privacy policy created by Generate Privacy Policy<br/>
		</div>
		<div class="span4">
