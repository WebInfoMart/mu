					...
					<div class="interest">
					 ...
					 <div class="career" style="float:left;">
						...
						<ul>
							...
							<li style="text-align:center">Analysis, Evaluation, Technical, Critical Assessment</li>
							<li style="text-align:center"><strong>THINKING STYLE</strong></li>
							<li style="text-align:center">Rational, Precise, Thorough, Logical</li>
							<li style="text-align:center"><strong>CAREER PROFICIENCY</strong></li>
							<li style="text-align:center">Engineering, Banking, Legal, Medicine</li>
						</ul>
						<?php } else if(($score->lowerLeft>=$score->upperLeft)&&($score->lowerLeft>=$score->lowerRight)&&($score->lowerLeft>=$score->upperRight)){ ?>
						<ul>
							<li style="text-align:center"><strong>SKILLS</strong></li>
							<li style="text-align:center">Innovation, Lateral Thinking, Vision, Change Catalyst</li>
							<li style="text-align:center"><strong>THINKING STYLE</strong></li>
							<li style="text-align:center">Exploring, Imaginative, Adventurous, Experimental</li>
							<li style="text-align:center"><strong>CAREER PROFICIENCY</strong></li>
							<li style="text-align:center">Entrepreneurship, Management Consulting, Strategizing</li>
						</ul>
						<?php } else if(($score->lowerRight>=$score->upperLeft)&&($score->lowerRight>=$score->lowerLeft)&&($score->lowerRight>=$score->upperRight)){ ?>
						<ul>
							<li style="text-align:center"><strong>SKILLS</strong></li>
							<li style="text-align:center">Organization, Implementation, Accuracy, Administration</li>
							<li style="text-align:center"><strong>THINKING STYLE</strong></li>
							<li style="text-align:center">Methodical, Procedural, Reliable, Predictable</li>
							<li style="text-align:center"><strong>CAREER PROFICIENCY</strong></li>
							<li style="text-align:center">Planning, Supervising, Administration, Auditing</li>
						</ul>
						<?php } else if(($score->upperRight>=$score->upperLeft)&&($score->upperRight>=$score->lowerLeft)&&($score->upperRight>=$score->lowerRight)){ ?>
						<ul>
							<li style="text-align:center"><strong>SKILLS</strong></li>
							<li style="text-align:center">Customer Relations, Training, Communications, Need Analysis</li>
							<li style="text-align:center"><strong>THINKING STYLE</strong></li>
							<li style="text-align:center">Emotional, Humanistic, Sociable, Empathetic</li>
							<li style="text-align:center"><strong>CAREER PROFICIENCY</strong></li>
							<li style="text-align:center">Social Work, Sales, Music, Teaching</li>
						</ul>
						<?php } ?>
				     </div>
					 <div class="interest">
