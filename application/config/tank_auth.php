...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'MeetUniversity';
$config['webmaster_email'] = 'Meetuniv@meetuniv.com';
...
$config['recaptcha_public_key'] = '6LcVr-USAAAAAEKeu-Geo_Lga0avWe7PNu9RwWzz';
$config['recaptcha_private_key'] = '6LcVr-USAAAAAIWHyWuMZPoVqnTWrMJTzQ8UlztV';
