...
if ('' != $config['homepage_title'])
{
	...
	$meta_title = 'Exam Preparation Tips| How to Prepare for Interview | MeetUniv';
}
else
{
...
$meta_description = "MeetUniv offers free exam preparation video tips for students to help them to learn English grammar and success in exams such as IELTS, PTE, GMAT, GRE, IIT/JEE.";
// end
