         ...
         <!--<section id="primary_footer">
            <article class ="row container">
               ...
               <div class="create_profile span5"> Create a free profile to start saving schools !
                  <a href="http://meetuniv.com/register"><button type="submit" class="btn btn-primary">SIGN UP NOW &raquo;</button></a>
               </div>
            </article>
         </section>-->
			...
			<div class="container">
					...
					<div class="span2">
						<ul class="nav nav-list">
						  ...
						  <li><a href="http://meetuniv.com/contact-us?type=4"> Resume Writing</a></li>
